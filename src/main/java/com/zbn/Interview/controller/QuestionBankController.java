...
import com.zbn.Interview.constant.HotKeyConstant;
...
import com.zbn.Interview.model.dto.questionBank.QuestionBankAddRequest;
import com.zbn.Interview.model.dto.questionBank.QuestionBankEditRequest;
import com.zbn.Interview.model.dto.questionBank.QuestionBankQueryRequest;
import com.zbn.Interview.model.dto.questionBank.QuestionBankUpdateRequest;
...
public class QuestionBankController {
     ...
     */
    @PostMapping("/get/vo")
    @HotKeyCache(value = HotKeyConstant.HOT_KEY_QUESTION_BANK, param = "questionBankQueryRequest")
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(@RequestBody QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        Boolean needQuestionQuery = questionBankQueryRequest.getNeedQuestionQuery();
        if (needQuestionQuery) {
            // 查询问题
        ...
        String key = HotKeyConstant.HOT_KEY_QUESTION_BANK + id;
        // 设置缓存
